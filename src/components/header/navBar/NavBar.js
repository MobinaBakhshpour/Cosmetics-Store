    ...
    return (
        <div className="navBar">
            ...
            <div className="leftSection">
                ...
                <div className='basketIcon'><a href="#"><svg width={32} height={32} fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='userIcon'><a href="#"><svg width={32} height={32} fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
