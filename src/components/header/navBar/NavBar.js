    ...
    return (
        <div className="navBar">
            ...
            <div className="leftSection">
                ...
                <div className='basketIcon'><Link onClick={() => { contextValue.setIsShowSlidebarProduct(true) }}><svg width={38} height={38} fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
